...
const PortfolioPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>Portfolio - SolAI</title>
        <meta name="description" content="Manage and track your Solana portfolio" />
      </Head>
        ...
        <header className="border-b border-[var(--border-default)] bg-[var(--bg-secondary)] backdrop-blur-sm">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="text-lg text-[var(--text-primary)]">Portfolio</div>
            </div>
            <div className="flex items-center gap-3">
              <ThemeToggle />
              <WalletMultiButton />
